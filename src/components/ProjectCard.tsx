...
import type { Project } from '../types/project'; // <-- CORRIGÉ : type import
...
const ProjectCard: React.FC<ProjectCardProps> = ({ project }) => {
  return (
    <div 
      ...
      // Effet d'interface : clarté au survol
      onMouseOver={(e) => {
    ...
    >
      ...
      {/* 2. Stack Technique (Fichiers de données) */}
