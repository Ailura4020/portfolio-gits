...
// ... (Garde la constante SECTION_CONFIG telle quelle) ...
const SECTION_CONFIG = [
  {
    id: 'home',
    desktop: '/backgrounds/home.jpg',
    mobile: '/backgrounds/mobile/mobile-home.jpg', 
    fallbackColor: 'radial-gradient(circle at 50% 50%, #050a14 0%, #000000 100%)' 
  },
  {
    id: 'projects',
    desktop: '/backgrounds/project.jpg',
    mobile: '/backgrounds/mobile/mobile-projects.jpg',
    fallbackColor: 'linear-gradient(to bottom, #1a1a00, #0a0a0a)'
  },
  {
    id: 'experience',
    desktop: '/backgrounds/experiences.jpg',
    mobile: '/backgrounds/mobile/mobile-experiences.jpg',
    fallbackColor: 'linear-gradient(to right, #000c1a, #001a33)'
  },
  {
    id: 'skills',
    desktop: '/backgrounds/diagnostic.jpg',
    mobile: '/backgrounds/mobile/mobile-skills.jpg',
    fallbackColor: 'linear-gradient(45deg, #1a0000, #00001a)'
  },
  {
    id: 'contact',
    desktop: '/backgrounds/communication.jpg',
    mobile: '/backgrounds/mobile/mobile-contact.jpg',
...
const BackgroundManager: React.FC<BackgroundManagerProps> = ({ hoveredSection, onSectionChange }) => {
  ...
  return (
    <div style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100vh', zIndex: -1, overflow: 'hidden', backgroundColor: '#000' }}>
          ...
          >
            <div 
              ...
              style={{
                ...
                backgroundColor: isMobile ? 'rgba(0, 0, 0, 0.6)' : 'rgba(0, 2, 10, 0.4)', 
                backdropFilter: 'none' 
            }}></div>
          </div>
        );
      ...
      {/* --- NOUVEAU : LE FADE TO BLACK (Fondu vers le bas) --- */}
      <div style={{
        position: 'absolute',
        bottom: 0,
        left: 0,
        width: '100%',
        height: '25%', // Le fondu prend le quart bas de l'écran
        background: 'linear-gradient(to bottom, transparent, #050505)', // Du transparent vers la couleur de fond du site
        pointerEvents: 'none',
        zIndex: 10
      }}></div>
