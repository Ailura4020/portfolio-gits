...
import ProjectCard from '../components/ProjectCard.tsx'; // <-- CORRIGÉ
import type { Project } from '../types/project.ts'; // <-- CORRIGÉ

// --- Les Données de tes Projets (Artefacts Techniques) ---
